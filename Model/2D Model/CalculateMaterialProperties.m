function e = CalculateMaterialProperties(model,par,vect,phi,plot)
X1 = ceil((model.p3(1)-model.lx/2)/par.dx);
X2 = ceil((model.p3(1)+model.lx/2)/par.dx);
Y1 = ceil((model.p3(2)-model.ly/2)/par.dy);
Y2 = ceil((model.p3(2)+model.ly/2)/par.dy);
Areax = X1:X2;
Areay = Y1:Y2;
